                ...
                if ($id !== false) {
                    ...
                    foreach ($form->description['input'] as $key => $input) {
                        ...
                        foreach ($heading['options'] as $option) {
                            ...
                            if ($option['id'] == 'tf_rf_input[]') {
                                ...
                                // for select that have more than 1 option add a custom class
                                if( count($option['options']) > 1 ) {
                                    $option['properties']['class'] .= ' tf-rf-default-input';
                                }
                    ...
                    if ($heading['id'] == 'form_settings') {
                        foreach ($heading['options'] as $key => $option) {
                            ...
                            if ($option['id'] == 'tf_rf_select[]') {
                                // for select that have more than 1 option add a custom class
                                if ( count( $option['options'] ) > 1 ) {
                                    $option['properties']['class'] .= ' tf-rf-default-input';
                                }
                                $heading['options'][$key] = $option;
                            }
