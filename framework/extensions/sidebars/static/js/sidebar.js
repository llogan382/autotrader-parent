...
jQuery(document).ready(function(){
    ...
    for(i=0;i<tf_script.dynamic_sidebar_ids.length;i++)
    {
        if( $('#'+tf_script.dynamic_sidebar_ids[i]).prev('.sidebar-name').length==0 ) {
            $('#' + tf_script.dynamic_sidebar_ids[i]).find('.sidebar-name').find('h2').before($('#multi_delete_icon').html());
        }
        else {
            $('#' + tf_script.dynamic_sidebar_ids[i]).prev('.sidebar-name').find('h2').before($('#multi_delete_icon').html());
        }
    }
    ...
    $('#widgets-right .widgets-holder-wrap .sidebar-name h2').before($('#add_to_placeholder_mask').html());
