...
$atts = array(
    ...
    'options' => array(
        array(
            'name' => __('ID','tfuse'),
            'desc' => __('Specifies the post or page ID. For more detail about this shortcode follow the <a href="//codex.wordpress.org/Template_Tags/get_posts" target="_blank">link</a>','tfuse'),
