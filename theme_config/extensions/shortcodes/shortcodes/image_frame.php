...
function tfuse_frame($atts, $content = null)
{
    ...
    if ($prettyphoto == 'true')
        return '<a href="' . $src . '" target="' . $target . '" data-rel="prettyPhoto" rel="prettyPhoto" title = "' . $alt . '" ><img class="' . $align . ' ' . $class . '" src="' . $src . '" src="' . $src . '"  width="' . $width . '" height="' . $height . '" alt="' . $alt . '" /></a>';
    else
        return '<a href="' . $link . '" target="' . $target . '" title = "' . $alt . '" ><img class="' . $align . ' ' . $class . '" src="' . $src . '"  width="' . $width . '" height="' . $height . '" alt="' . $alt . '" /></a>';
}
