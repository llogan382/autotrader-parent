                ...
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => __('User reservation title','tfuse'),
                            ...
                            'type' => 'text'),
                        array('name' => __('Use in content','tfuse'),
                            'desc' => __('If you want to use in extra content(in before or after content) element select the specific option','tfuse'),
                            'id' => 'tf_rf_position',
                            'value' => 'content',
                            'options' => array('content' => __('Content','tfuse'), 'before_content' => __('Before/After Content','tfuse')),
                            'type'=>'select'),
                    )
                ),
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => '',
                            ...
                            'value' => '',
                            'html' => '<span class="show_more_less">'.__('+Show more','tfuse').'</span>',
                            'divider' => true,
                        ),
                        array('name' => '',
                            'desc' => '',
                ...
                array(
                    ...
                    'options' => array(
	                    ...
	                    array('name' => __('Form template','tfuse'),
	                          ...
	                          'value' => '<span>[label]</span><span>[input]</span>',
	                          'type' => 'textarea'),
