...
global $TFUSE;
$cfg['valid_types'] =  array('custom','categories','posts');

$cfg['setup'] = array(
    array(
        'design' => 'fullbanner',
        'name' => __('FullBanner', 'tfuse')
    ),
    array(
        'design' => 'featured',
        'name' => __('Featured', 'tfuse')
    ),
    array(
        'design' => 'image_video',
        'name' => __('ImageVideo', 'tfuse')
    ),
    array(
        'design' => 'carousel',
...
//*********************
$type_select = array('' => __('Choose your slider type','tfuse'));
                ...
                array(
                    ...
                    'options' => array(
                        array(
                            ...
                            'desc' => __('Choose the slider type. You can check the sliders in the <a target="_black" href="//themefuse.com/demo/wp/cloudhost/">demo live preview</a> on our website.','tfuse'),
