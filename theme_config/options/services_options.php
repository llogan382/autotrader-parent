...
$options = array(
    ...
    // Text Button
    array('name' => __('Enable Icon Services','tfuse'),
        'desc' => __('Enable the shortcode of icon services.','tfuse'),
        'id' => TF_THEME_PREFIX . '_icon_services',
        'value' => true,
        'type' => 'checkbox'
    ),
    // Text Button
    array('name' => __('Text button','tfuse'),
        'desc' => __('In this input you can number or information text for button.','tfuse'),
        'id' => TF_THEME_PREFIX . '_button_text',
        'value' => '',
        'type' => 'text'
    ),
    // Top Shortcodes
