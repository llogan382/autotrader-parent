...
$options = array(
    ...
    // Post Meta
    array('name' => __('Enable FAQ Meta','tfuse'),
        'desc' => '',
        'id' => TF_THEME_PREFIX . '_enable_post_meta',
        'value' => tfuse_options('enable_post_meta_faqs',true),
        'type' => 'checkbox'
    ),
    // Published Date
    ...
    // Author Post
    array('name' => __('Enable Author','tfuse'),
        'desc' => '',
    ...
    array('name' => __('Enable Comments','tfuse'),
        ...
        'value' => tfuse_options('enable_posts_comments_faq',true),
        'type' => 'checkbox',
